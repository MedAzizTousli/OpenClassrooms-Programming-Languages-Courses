...
public class list_element2 extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_element2);
        Button btnSave = findViewById(R.id.Save2);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.Save2)
        {
            ...
            Intent intent = new Intent(list_element2.this, choix.class);
